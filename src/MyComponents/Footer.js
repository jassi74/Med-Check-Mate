                    ...
                    <div data-position="" className="u-position">
                      <div className="u-block">
                        <div className="u-block-container u-clearfix">
                          ...
                          <div className="u-block-content u-text">Capstone project on Blockchain-based Pharmaceutical supply Tracing and authentication system </div>
                        </div>
                      </div>
                    </div>
                  </div>                </div>
                    ...
                    <div data-position="" className="u-position">
                      <div className="u-block">
                        <div className="u-block-container u-clearfix">
                          ...
                          <div className="u-block-content u-text">Electronics and Communication Department 
December 2022</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div data-position="" className="u-position u-position-3">
                      <div className="u-block">
                        <div className="u-block-container u-clearfix">
                          ...
                          <div className="u-block-content u-text">(101915048) Harsh Garg</div>
                          <div className="u-block-content u-text">(101915016) Bhavik Jain </div>
                          <div className="u-block-content u-text">(101915064)  Jaskirat Singh</div>
                          <div className="u-block-content u-text">(101915171) Lovish Jindal</div>
                          <div className="u-block-content u-text">BE Fourth Year- ENC CPG No: 58</div>
